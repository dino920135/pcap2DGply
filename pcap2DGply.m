...
defaultPath = 'F:\NCKU Projects\Meeting_20201024\New Experiment 1005-1007\1007\20201007_A_Taichung\LiDAR_VLP16\';
...
timeInterval = [10951 13410];
UTF_timeZone = 8;       % time zone of the collected data
deviceModel = 'VLP16';  % Velodyne LiDAR Model
saveFile = 1;           % Save File or NOT
pcFilter = 0;           % Filter point cloud with XY bounding box
Seg_DG = 0;

filterPlane = ...
    {[118.381470 86.404182
117.237076 88.619827
111 85.5
111 83]};
filterMinZ = 25;
